...
public class PermissionController {
    ...
    @ResponseBody
    public ApiResponseService postPermission(@RequestBody @Valid PermissionDTO permissionDTO) throws EntryNotFoundException {
        Permission permission = permissionMapper.toPermission(permissionDTO);
        this.permissionDAO.savePermissionToDatabase(permission);
        return new ApiResponseService(HttpStatus.CREATED, "Permission has been posted to the database!");
    }
